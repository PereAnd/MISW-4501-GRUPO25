...
from .vistas import  VistaPing, VistaRegistro, VistaEmpresa, VistaVertical, VistaVerticales, VistaUbicaciones, VistaUbicacion, VistaProyecto, VistaProyectos,VistaEntrevistas
